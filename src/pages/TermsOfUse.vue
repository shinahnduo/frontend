<template>
  ...
  >
    ...
    >
      ...
      and capacity to enter into these Terms. YOU SHOULD BE AT LEAST 15 YEARS OF
    ...
    <p>
      ...
      betterwrite.io uses ‘cookies’. These cookies are used to store information
    ...
    <p>
      ...
      should be sent to: Brazil. After the Notice is received, you and the
